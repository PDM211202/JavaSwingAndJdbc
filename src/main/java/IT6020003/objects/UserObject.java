...
public class UserObject {
	...
	public short getUser_permission() {
		return user_permission;
	}

	public void setUser_permission(short user_permission) {
	...
	public short getUser_actions() {
		return user_actions;
	}

	public void setUser_actions(short user_actions) {
