...
public class ArticleObject {
	...
	public String toString() {
		return "ArticleObject [article_id=" + article_id + ", article_title=" + article_title + ", article_summary="
				+ article_summary + ", article_content=" + article_content + ", article_created_date="
				+ article_created_date + ", article_last_modified=" + article_last_modified + ", article_image="
				+ article_image + ", article_category_id=" + article_category_id + ", article_section_id="
				+ article_section_id + ", article_visited=" + article_visited + ", article_author_name="
				+ article_author_name + ", article_enable=" + article_enable + ", article_url_link=" + article_url_link
				+ ", article_tag=" + article_tag + ", article_title_en=" + article_title_en + ", article_summary_en="
				+ article_summary_en + ", article_content_en=" + article_content_en + ", article_tag_en="
				+ article_tag_en + ", article_fee=" + article_fee + ", article_isfee=" + article_isfee
				+ ", article_delete=" + article_delete + ", article_deleted_date=" + article_deleted_date
				+ ", article_restored_date=" + article_restored_date + ", article_modified_author_name="
				+ article_modified_author_name + ", article_author_permission=" + article_author_permission
				+ ", article_source=" + article_source + ", article_language=" + article_language + ", article_focus="
				+ article_focus + ", article_type=" + article_type + ", article_forhome=" + article_forhome + "]";
	}
}
